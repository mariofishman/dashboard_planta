# EmusaSoft and MCP Audit Evidence — 2026-07-22

**Status:** Superseded dated evidence; its closure-snapshot field list was replaced on 2026-07-23

**Current evidence:** [`database_and_mcp_compatibility_audit_2026-07-23.md`](database_and_mcp_compatibility_audit_2026-07-23.md)

**Audit endpoint:** `https://emusa-mcp-tasks-stg-api.emusa.dev/mcp`

**Audit time:** 2026-07-22 19:08 PET (`UTC-05:00`)

**Purpose:** record the exact staging MCP evidence used to reconcile the active integration register.

**Current register:** [`../integration_register.md`](../integration_register.md)

**Architecture:** [`../../../architecture/system_architecture.md`](../../../architecture/system_architecture.md)

**Roadmap:** [`../../../roadmap.md`](../../../roadmap.md)
**Superseded records:** `archive/docs/implementation/`

This audit corrected the earlier conclusion that the MCP upgrade was not deployed. The staging endpoint exposed catalog v5, frontend routes, GraphQL type descriptions, catalog provenance, recipe snapshots, and an extrusion-container closure-snapshot contract.
