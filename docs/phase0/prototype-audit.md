...
| P0 | Prototype EmusaSoft links have no supported frontend-route contract. | Remove navigation actions; show ERP identifiers and evidence in Monitor. |
...
| P1 | Roster has no approved workflow or prototype. | Use `roster-design-brief.md`; design and validate before Phase 5. |
