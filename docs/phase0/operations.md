...
| Environment | EmusaSoft source | Freshness | Purpose |
|---|---|---|---|
...
| Staging | Approved Aurora read replica | Required | Phase 10 EmusaSoft integration and acceptance |
| Production | Approved Aurora read replica | Required | Phase 10 deployment; disabled until all production gates pass |
...
- EmusaSoft team: authentication microservice, ERP authorization semantics, read replica, credentials, query/index approval, load budget, and freshness signal for Phase 10.
