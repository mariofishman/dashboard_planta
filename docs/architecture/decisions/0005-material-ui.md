...
**Status:** accepted; supersedes ES2-07
**Date:** 2026-07-20

## Decision

Monitor uses Material UI behind a small Monitor component layer. It imports tokens from `docs/design/design-system/tokens.json` and follows `docs/design/design.md`, `docs/design/brand_guidelines.md`, and `docs/product/ux_ui_decisions.md`.
...
- Remove ES2-07 as a delivery dependency.
