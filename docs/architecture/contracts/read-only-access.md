...
Production is disabled until ES2-02 supplies and proves this contract.
...
Connection, timeout, contract, truncation, incomplete-result, or persistence failure marks the cycle unhealthy and preserves incident state.
