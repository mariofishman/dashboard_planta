...
These intervals detect a 30-minute breach within at most about five additional minutes while keeping a deliberately small local starting load. Production intervals remain disabled until ES2-01 and ES2-02 approve staging plans and a load budget.
...
- Index creation belongs to EmusaSoft and requires ES2-01 review; Monitor does not apply indexes to EmusaSoft.
