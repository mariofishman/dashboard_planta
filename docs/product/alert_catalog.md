...
This is the canonical source for Monitor's approved alert rules within the product defined by `docs/product/product_definition.md`. The approved browser publication is `reviews/alert-catalog/publication/index.html`; iteration 11 records the review in which E05 was approved.
