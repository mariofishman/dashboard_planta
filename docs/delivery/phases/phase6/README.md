...
**Role:** Phase 6 status index; the linked Stage 5 plan is the sole Stage 5 execution and evidence authority

**Status:** In progress; Stages 1–4 complete; Stage 5 corrective work is current; Stage 6 is pending
...
| 5 — Run connected acceptance | **Corrective work in progress** | Follow the single [Stage 5 corrective execution plan](./stage5_corrective_execution_plan.md). | The plan's Stage 5 exit assertions pass and the user accepts the evidence. |
...
## Immediate next action — Stage 5 corrective execution

Use the single [Stage 5 corrective execution plan](./stage5_corrective_execution_plan.md). It owns the steps, checkpoint assessment, file classification, requirement trace, exact 34-test inventory, exit gates, and eventual Stage 5 evidence status.
...
- [`stage5_corrective_execution_plan.md`](./stage5_corrective_execution_plan.md) — the only current Stage 5 execution and evidence authority.
