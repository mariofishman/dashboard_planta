...
3. external dependencies already assigned in docs/integrations/emusasoft/integration_register.md.
...
```text
Use $microplan-workflow to implement the next approved unit from Phase [number] of docs/roadmap.md.
