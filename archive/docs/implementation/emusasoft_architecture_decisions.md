...
**Status:** historical record superseded by `docs/architecture/system_architecture.md` on 2026-07-20

The current integration contract is `docs/architecture/system_architecture.md`. This file is retained only as historical evidence of the architect decision sequence and has no current authority.
