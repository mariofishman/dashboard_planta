...
export class B01StandaloneLaboratory {
  ...
  evaluate(cycle: B01LaboratoryCycle): B01LaboratoryResult {
    ...
    if (snapshot.actualStarted === true && (snapshot.actualStartedAt === undefined || snapshot.actualStartedAt === null)) {
      missingEvidence.push("actualStartedAt");
    }
    ...
    if (
      ...
      || (snapshot.actualStarted === true && (snapshot.actualStartedAt === undefined || snapshot.actualStartedAt === null))
