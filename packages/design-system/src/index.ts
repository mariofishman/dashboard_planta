...
export const monitorSemanticTokens = {
  color: {
    ...
    alertOpenBorder: resolve<string>(semantic.color.alertOpenBorder),
    alertOpenHeader: resolve<string>(semantic.color.alertOpenHeader),
    alertOpenLabelBorder: resolve<string>(semantic.color.alertOpenLabelBorder),
    alertResolvedBorder: resolve<string>(semantic.color.alertResolvedBorder),
    alertResolvedHeader: resolve<string>(semantic.color.alertResolvedHeader),
